    ...
    for path, im, im0s, gps_info, vid_cap in tqdm(dataset):
        ...
        for i,det in enumerate(pred):
            ...
            if det is not None and len(det):
                ...
                gps_coords = absolute_coordinates(im1.shape,gps_info['gimbal_heading'].to_numpy(),gps_info['altitude'].to_numpy(),gps_info['gimbal_pitch'].to_numpy(), x_center, y_center, gps_info['gps_latitude'].to_numpy(), gps_info['gps_longitude'].to_numpy(),)
